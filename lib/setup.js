...
function npmInstall(packet, isSudo, callback) {
    ...
    if (platform === 'linux' || platform === 'darwin') {
        cmd = 'npm install ' + packet + ' --production --save --loglevel verbose --prefix ' + _path;
...
function setup(callback) {
    ...
    var debPack = JSON.parse(fs.readFileSync(rootDir + 'package.json').toString());
    console.log(rootDir + 'package.json BEFORE: ' + JSON.stringify(debPack, null, 2));
			...
			npmInstall('iobroker.js-controller', false, function () {
                ...
                try {
                    if (fs.existsSync(rootDir + 'package.json')) {
                        ...
                        console.log(rootDir + 'package.json BEFORE: ' + JSON.stringify(pack, null, 2));
                        ...
                        console.log(rootDir + 'package.json AFTER: ' + JSON.stringify(pack, null, 2));
                    }
                    else {
                        console.error(rootDir + 'package.json DOES NOT exists!!');
                    }
                } catch (e) {
