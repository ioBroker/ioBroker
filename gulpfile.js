...
gulp.task('create', () => {
    return new Promise(resolve => {
        ...
        const nodeUpdate = fs.readFileSync(`${__dirname}/node_update.sh`).toString('utf8');
        ...
        fs.writeFileSync(`${dist}node_update.sh`,    nodeUpdate);
